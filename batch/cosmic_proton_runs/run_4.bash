...
#SBATCH -o ./log/cosmic_proton_4_%j.out
#SBATCH -e ./log/cosmic_proton_4_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_4.mac -t 20
