...
#SBATCH -o ./log/cosmic_proton_1_%j.out
#SBATCH -e ./log/cosmic_proton_1_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_1.mac -t 20
