...
#SBATCH -o ./log/cosmic_neutron_4_%j.out
#SBATCH -e ./log/cosmic_neutron_4_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_neutron/run_4.mac -t 20
