...
#SBATCH -o ./log/cosmic_neutron_2_%j.out
#SBATCH -e ./log/cosmic_neutron_2_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_neutron/run_2.mac -t 20
