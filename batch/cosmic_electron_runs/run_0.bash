...
#SBATCH -o ./log/cosmic_electron_0_%j.out
#SBATCH -e ./log/cosmic_electron_0_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_0.mac -t 20
