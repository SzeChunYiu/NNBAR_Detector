...
#SBATCH -o ./log/cosmic_electron_1_%j.out
#SBATCH -e ./log/cosmic_electron_1_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_1.mac -t 20
