...
#SBATCH -o ./log/cosmic_electron_4_%j.out
#SBATCH -e ./log/cosmic_electron_4_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_4.mac -t 20
