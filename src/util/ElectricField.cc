...
{
	// ============================================================================
	// TPC Electric Field Configuration
	// ============================================================================
	// For Ar/CO2 (80/20) gas mixture:
	//   - Typical drift field: 200-500 V/cm
	//   - Optimal at ~400 V/cm for drift velocity ~4 cm/µs
	//   - Field direction: along drift direction (radial for cylindrical TPC)
	// ============================================================================
	...
	eField[3] = 0;  //E_x
	eField[4] = 0;  //E_y
	eField[5] = 400.0*volt/cm; //E_z - drift field along z-axis
	eField[6] = 0.; //Unused
