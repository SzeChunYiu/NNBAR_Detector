...
void Silicon::DefineMaterials()
{
  ...
  // = = B4C (check if already defined in beampipe_geometry)
  ...
  // beamline coating materials (check if already defined in beampipe_geometry)
  // = = Li6
...
std::vector<G4LogicalVolume*> Silicon::Construct_Volumes(G4LogicalVolume* mother)
{
  ...
  G4double Silicon_coating_thickness = 0.1*cm;
    ...
    ///////////////////////////////////////
      ...
      new G4PVPlacement(0,G4ThreeVector(0., 0., 0.),siliconLV_1,"siliconPV_1",mother,false,0,false);
      ...
      new G4PVPlacement(0,G4ThreeVector(0., 0., 0.),siliconLV_2,"siliconPV_2",mother,false,1,false);
    ...
    ///////////////////////////////////////
      ...
      new G4PVPlacement(0,G4ThreeVector(0., 0., 0.),silicon_coating_1_LV,"silicon_coating_PV",mother,false,0,false);
      new G4PVPlacement(0,G4ThreeVector(0., 0., 0.),silicon_coating_2_LV,"silicon_coating_2_PV",mother,false,1,false);
