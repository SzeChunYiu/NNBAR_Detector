...
void Beampipe::DefineMaterials()
{
  ...
  (void)a; (void)z;  // Used in G4Material constructors
  ...
  // beamline coating materials (check if already defined elsewhere)
  // = = Li6
  if (!G4Material::GetMaterial("el_Li6", false)) {
    ...
    // = = 6LiF (depends on el_Li6 element created above)
  ...
  // Beampipe
  // = = Aluminum
  if (!G4Material::GetMaterial("Aluminum", false)) {
    new G4Material("Aluminum", z=13., a=26.98*g/mole, density=2.7*g/cm3);
  }
  // = = stainless steel
  if (!G4Material::GetMaterial("StainlessSteel", false)) {
...
std::vector<G4LogicalVolume*> Beampipe::Construct_Volumes(G4LogicalVolume* mother)
{
  ...
  auto Beampipe_1_LV = new G4LogicalVolume(Beampipe_1_S,DefaultMaterial,"Beampipe_1_LV");
        ...
        new G4PVPlacement(0,G4ThreeVector(0.,0.,0.),Beampipe_1_wall_LV,"Beampipe_1_wall_PV",Beampipe_1_LV,false,0,false);
        new G4PVPlacement(0,G4ThreeVector(0.,0.,0.),Beampipe_1_coating_LV,"Beampipe_1_coating_PV",Beampipe_1_LV,false,0,false);
  ...
  auto Beampipe_2_LV = new G4LogicalVolume(Beampipe_2_S,DefaultMaterial,"Beampipe_2_LV");
        ...
        auto Beampipe_2_wall_LV = new G4LogicalVolume(Beampipe_2_wall_S,BeampipeMaterial,"Beampipe_2_wall_LV");
        auto Beampipe_2_coating_LV = new G4LogicalVolume(Beampipe_2_coating_S,B4CMaterial,"Beampipe_2_coating_LV");

        new G4PVPlacement(0,G4ThreeVector(),Beampipe_2_wall_LV,"Beampipe_2_wall_PV",Beampipe_2_LV,false,0,false);
        new G4PVPlacement(0,G4ThreeVector(),Beampipe_2_coating_LV,"Beampipe_2_coating_PV",Beampipe_2_LV,false,0,false);
  ...
  auto Beampipe_4_LV = new G4LogicalVolume(Beampipe_4_S,DefaultMaterial,"Beampipe_4_LV");
        ...
        auto Beampipe_4_wall_LV = new G4LogicalVolume(Beampipe_4_wall_S,BeampipeMaterial,"Beampipe_4_wall_LV");
        auto Beampipe_4_coating_LV = new G4LogicalVolume(Beampipe_4_coating_S,B4CMaterial,"Beampipe_4_coating_LV");

        new G4PVPlacement(0,G4ThreeVector(),Beampipe_4_wall_LV,"Beampipe_4_wall_PV",Beampipe_4_LV,false,0,false);
        new G4PVPlacement(0,G4ThreeVector(),Beampipe_4_coating_LV,"Beampipe_4_coating_PV",Beampipe_4_LV,false,0,false);
  ...
  auto Beampipe_5_LV = new G4LogicalVolume(Beampipe_5_S,DefaultMaterial,"Beampipe_5_LV");
        ...
        // Shorten coating to avoid overlap with disc coatings at each end
        auto Beampipe_5_coating_S = new G4Cons("Beampipe_5_coating_S",
                                                ...
                                                Beampipe_5_radius_1-Beampipe_coating_thickness,Beampipe_5_radius_1,
                                                (Beampipe_5_len - Beampipe_6_coating_thickness - Beampipe_7_coating_thickness)/2.,0.,Beampipe_angle);
        ...
        new G4PVPlacement(0,G4ThreeVector(),Beampipe_5_wall_LV,"Beampipe_5_wall_PV",Beampipe_5_LV,false,0,false);
        new G4PVPlacement(0,G4ThreeVector(),Beampipe_5_coating_LV,"Beampipe_5_coating_PV",Beampipe_5_LV,false,0,false);
  ...
  auto Beampipe_8_LV = new G4LogicalVolume(Beampipe_8_S,DefaultMaterial,"Beampipe_8_LV");
        ...
        auto Beampipe_8_wall_LV = new G4LogicalVolume(Beampipe_8_wall_S,BeampipeMaterial,"Beampipe_8_wall_LV");
        auto Beampipe_8_coating_LV = new G4LogicalVolume(Beampipe_8_coating_S,B4CMaterial,"Beampipe_8_coating_LV");

        new G4PVPlacement(0,G4ThreeVector(),Beampipe_8_wall_LV,"Beampipe_8_wall_PV",Beampipe_8_LV,false,0,false);
        new G4PVPlacement(0,G4ThreeVector(),Beampipe_8_coating_LV,"Beampipe_8_coating_PV",Beampipe_8_LV,false,0,false);
  ...
  new G4PVPlacement(0,G4ThreeVector(0., 0.,-BeamStop_len/2.+BeamStop_Absorber_thickness/2.),BeamStop_Absorber_LV,"BeamStop_Absorber_PV",BeamStop_LV,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0.,-BeamStop_len/2.+BeamStop_Absorber_thickness+BeamStop_Metal_thickness/2.),BeamStop_Metal_LV,"BeamStop_Metal_PV",BeamStop_LV,false,0,false);
  ...
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_1_pos_z),Beampipe_1_LV,"Beampipe_1_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_2_pos_z),Beampipe_2_LV,"Beampipe_2_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_3_pos_z),Beampipe_3_LV,"Beampipe_3_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_3_coating_pos_z),Beampipe_3_coating_LV,"Beampipe_3_coating_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_4_pos_z),Beampipe_4_LV,"Beampipe_4_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_5_pos_z),Beampipe_5_LV,"Beampipe_5_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_6_pos_z),Beampipe_6_LV,"Beampipe_6_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_6_coating_pos_z),Beampipe_6_coating_LV,"Beampipe_6_coating_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_7_pos_z),Beampipe_7_LV,"Beampipe_7_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_7_coating_pos_z),Beampipe_7_coating_LV,"Beampipe_7_coating_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_8_pos_z),Beampipe_8_LV,"Beampipe_8_PV",mother,false,0,false);
  new G4PVPlacement(0,G4ThreeVector(0., 0., BeamStop_pos_z),BeamStop_LV,"BeamStop_PV",mother,false,0,false);
  ...
  //////////////////////////////////////////////////////////////////////
  //////////////////// GeometryManager Registration ////////////////////
  //////////////////////////////////////////////////////////////////////

  auto& geoMgr = nnbar::GeometryManager::Instance();

  // Section 1: Conical section from source (expanding radius)
  geoMgr.RegisterBeampipeSection(1, "Beampipe_1", "wall",
                                 Beampipe_1_pos_z/mm,
                                 Beampipe_1_radius_11/mm, Beampipe_1_radius_12/mm,
                                 Beampipe_1_radius_21/mm, Beampipe_1_radius_22/mm,
                                 Beampipe_1_len/2./mm, "Aluminum");

  // Section 2: Long cylindrical section
  geoMgr.RegisterBeampipeSection(2, "Beampipe_2", "wall",
                                 Beampipe_2_pos_z/mm,
                                 Beampipe_2_radius_1/mm, Beampipe_2_radius_2/mm,
                                 Beampipe_2_radius_1/mm, Beampipe_2_radius_2/mm,
                                 Beampipe_2_len/2./mm, "Aluminum");

  // Section 3: Cap between sections 2 and 4
  geoMgr.RegisterBeampipeSection(3, "Beampipe_3", "cap",
                                 Beampipe_3_pos_z/mm,
                                 Beampipe_3_radius_1/mm, Beampipe_3_radius_2/mm,
                                 Beampipe_3_radius_1/mm, Beampipe_3_radius_2/mm,
                                 Beampipe_3_len/2./mm, "Aluminum");

  // Section 4: Short section before detector
  geoMgr.RegisterBeampipeSection(4, "Beampipe_4", "wall",
                                 Beampipe_4_pos_z/mm,
                                 Beampipe_4_radius_1/mm, Beampipe_4_radius_2/mm,
                                 Beampipe_4_radius_1/mm, Beampipe_4_radius_2/mm,
                                 Beampipe_4_len/2./mm, "Aluminum");

  // Section 5: Main detector section (r=1.12-1.14m, len=5m)
  geoMgr.RegisterBeampipeSection(5, "Beampipe_5", "wall",
                                 Beampipe_5_pos_z/mm,
                                 Beampipe_5_radius_1/mm, Beampipe_5_radius_2/mm,
                                 Beampipe_5_radius_1/mm, Beampipe_5_radius_2/mm,
                                 Beampipe_5_len/2./mm, "Aluminum");

  // Section 6: Front cap of detector section
  geoMgr.RegisterBeampipeSection(6, "Beampipe_6", "cap",
                                 Beampipe_6_pos_z/mm,
                                 Beampipe_6_radius_1/mm, Beampipe_6_radius_2/mm,
                                 Beampipe_6_radius_1/mm, Beampipe_6_radius_2/mm,
                                 Beampipe_6_len/2./mm, "Aluminum");

  // Section 7: Back cap of detector section
  geoMgr.RegisterBeampipeSection(7, "Beampipe_7", "cap",
                                 Beampipe_7_pos_z/mm,
                                 Beampipe_7_radius_1/mm, Beampipe_7_radius_2/mm,
                                 Beampipe_7_radius_1/mm, Beampipe_7_radius_2/mm,
                                 Beampipe_7_len/2./mm, "Aluminum");

  // Section 8: Section after detector
  geoMgr.RegisterBeampipeSection(8, "Beampipe_8", "wall",
                                 Beampipe_8_pos_z/mm,
                                 Beampipe_8_radius_1/mm, Beampipe_8_radius_2/mm,
                                 Beampipe_8_radius_1/mm, Beampipe_8_radius_2/mm,
                                 Beampipe_8_len/2./mm, "Aluminum");

  // Beam stop
  geoMgr.RegisterBeampipeSection(9, "BeamStop", "beamstop",
                                 BeamStop_pos_z/mm,
                                 BeamStop_radius_1/mm, BeamStop_radius_2/mm,
                                 BeamStop_radius_1/mm, BeamStop_radius_2/mm,
                                 BeamStop_len/2./mm, "Copper");

  // Coatings (B4C neutron absorber)
  geoMgr.RegisterBeampipeSection(101, "Beampipe_1_coating", "coating",
                                 Beampipe_1_pos_z/mm,
                                 (Beampipe_1_radius_11-Beampipe_coating_thickness)/mm, Beampipe_1_radius_11/mm,
                                 (Beampipe_1_radius_21-Beampipe_coating_thickness)/mm, Beampipe_1_radius_21/mm,
                                 Beampipe_1_len/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(102, "Beampipe_2_coating", "coating",
                                 Beampipe_2_pos_z/mm,
                                 (Beampipe_2_radius_1-Beampipe_coating_thickness)/mm, Beampipe_2_radius_1/mm,
                                 (Beampipe_2_radius_1-Beampipe_coating_thickness)/mm, Beampipe_2_radius_1/mm,
                                 Beampipe_2_len/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(103, "Beampipe_3_coating", "coating",
                                 Beampipe_3_coating_pos_z/mm,
                                 Beampipe_3_coating_radius_1/mm, Beampipe_3_coating_radius_2/mm,
                                 Beampipe_3_coating_radius_1/mm, Beampipe_3_coating_radius_2/mm,
                                 Beampipe_3_coating_thickness/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(104, "Beampipe_4_coating", "coating",
                                 Beampipe_4_pos_z/mm,
                                 (Beampipe_4_radius_1-Beampipe_coating_thickness)/mm, Beampipe_4_radius_1/mm,
                                 (Beampipe_4_radius_1-Beampipe_coating_thickness)/mm, Beampipe_4_radius_1/mm,
                                 Beampipe_4_len/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(105, "Beampipe_5_coating", "coating",
                                 Beampipe_5_pos_z/mm,
                                 (Beampipe_5_radius_1-Beampipe_coating_thickness)/mm, Beampipe_5_radius_1/mm,
                                 (Beampipe_5_radius_1-Beampipe_coating_thickness)/mm, Beampipe_5_radius_1/mm,
                                 (Beampipe_5_len - Beampipe_6_coating_thickness - Beampipe_7_coating_thickness)/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(106, "Beampipe_6_coating", "coating",
                                 Beampipe_6_coating_pos_z/mm,
                                 Beampipe_6_coating_radius_1/mm, Beampipe_6_coating_radius_2/mm,
                                 Beampipe_6_coating_radius_1/mm, Beampipe_6_coating_radius_2/mm,
                                 Beampipe_6_coating_thickness/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(107, "Beampipe_7_coating", "coating",
                                 Beampipe_7_coating_pos_z/mm,
                                 Beampipe_7_coating_radius_1/mm, Beampipe_7_coating_radius_2/mm,
                                 Beampipe_7_coating_radius_1/mm, Beampipe_7_coating_radius_2/mm,
                                 Beampipe_7_coating_thickness/2./mm, "B4C");

  geoMgr.RegisterBeampipeSection(108, "Beampipe_8_coating", "coating",
                                 Beampipe_8_pos_z/mm,
                                 (Beampipe_8_radius_1-Beampipe_coating_thickness)/mm, Beampipe_8_radius_1/mm,
                                 (Beampipe_8_radius_1-Beampipe_coating_thickness)/mm, Beampipe_8_radius_1/mm,
                                 Beampipe_8_len/2./mm, "B4C");
