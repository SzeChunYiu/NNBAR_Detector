...
void Beampipe_Shielding::DefineMaterials()
{
  ...
  new G4Material("Lead_shield", z=82., a= 207.2*g/mole, density = 11.29*g/cm3);
}
...
std::vector<G4LogicalVolume*> Beampipe_Shielding::Construct_Volumes(G4LogicalVolume* mother)
{
  ...
  //////////////////////////////////////////////////////////////////////
      ...
      // Shielding for Beampipe 2
            ...
            new G4PVPlacement(0,G4ThreeVector(0., 0., Beampipe_2_pos_z),Beampipe_Shielding_2_LV,"Beampipe_Shielding_2_PV",mother,false,0,false);
      ...
      // Shielding for Beampipe 4
            ...
            new G4PVPlacement(0,G4ThreeVector(0., 0.,(Beampipe_2_pos_z+Beampipe_2_len/2.+Beampipe_Shielding_4_len/2.)),Beampipe_Shielding_4_LV,"Beampipe_Shielding_4_PV",mother,false,0,false);
      ...
      // Shielding for Beampipe 8
            ...
            new G4PVPlacement(0,G4ThreeVector(0., 0.,Beampipe_Shielding_8_pos_z),Beampipe_Shielding_8_LV,"Beampipe_Shielding_8_PV",mother,false,0,false);
