...
#SBATCH -o ./log/cosmic_neutron_1_%j.out
#SBATCH -e ./log/cosmic_neutron_1_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_neutron/run_1.mac -t 20
