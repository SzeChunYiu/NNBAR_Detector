...
#SBATCH -o ./log/cosmic_neutron_3_%j.out
#SBATCH -e ./log/cosmic_neutron_3_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_neutron/run_3.mac -t 20
