...
#SBATCH -o ./log/cosmic_neutron_0_%j.out
#SBATCH -e ./log/cosmic_neutron_0_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_neutron/run_0.mac -t 20
