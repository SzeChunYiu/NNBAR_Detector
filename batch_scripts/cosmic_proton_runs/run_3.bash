...
#SBATCH -o ./log/cosmic_proton_3_%j.out
#SBATCH -e ./log/cosmic_proton_3_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_3.mac -t 20
