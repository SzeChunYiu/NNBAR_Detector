...
#SBATCH -o ./log/cosmic_proton_2_%j.out
#SBATCH -e ./log/cosmic_proton_2_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_2.mac -t 20
