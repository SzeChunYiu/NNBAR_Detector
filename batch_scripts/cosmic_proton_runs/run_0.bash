...
#SBATCH -o ./log/cosmic_proton_0_%j.out
#SBATCH -e ./log/cosmic_proton_0_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_0.mac -t 20
