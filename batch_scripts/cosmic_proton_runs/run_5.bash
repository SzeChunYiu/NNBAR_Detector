...
#SBATCH -o ./log/cosmic_proton_5_%j.out
#SBATCH -e ./log/cosmic_proton_5_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_proton/run_5.mac -t 20
