...
#SBATCH -o ./log/cosmic_electron_3_%j.out
#SBATCH -e ./log/cosmic_electron_3_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_3.mac -t 20
