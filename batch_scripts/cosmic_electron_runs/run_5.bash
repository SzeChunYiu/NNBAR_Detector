...
#SBATCH -o ./log/cosmic_electron_5_%j.out
#SBATCH -e ./log/cosmic_electron_5_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_5.mac -t 20
