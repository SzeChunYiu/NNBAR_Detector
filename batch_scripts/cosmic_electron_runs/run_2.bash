...
#SBATCH -o ./log/cosmic_electron_2_%j.out
#SBATCH -e ./log/cosmic_electron_2_%j.err
...
./nnbar-calo-sim -m ./macro/cosmic_macro/cosmic_electron/run_2.mac -t 20
